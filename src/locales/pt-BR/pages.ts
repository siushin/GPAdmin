export default {
  'pages.layouts.userLayout.title':
    'Seu depósito de Pokémon nunca mais será uma pilha bagunçada de Poké Bolas!',
  'pages.login.accountLogin.tab': 'Login da conta',
  'pages.login.accountLogin.errorMessage': 'usuário/senha incorreto(admin)',
  ...
  'pages.register.subtitle': 'Criar Nova Conta',
  'pages.register.submit': 'Registrar',
  'pages.register.failure': 'Registro falhou, por favor tente novamente!',
  'pages.register.username.placeholder': 'Nome de usuário',
  'pages.register.username.required': 'Por favor insira seu nome de usuário!',
  ...
  'pages.register.confirmPassword.placeholder': 'Confirmar Senha',
  'pages.register.confirmPassword.required': 'Por favor confirme sua senha!',
  'pages.register.confirmPassword.notMatch': 'As duas senhas não coincidem',
  'pages.register.phone.placeholder': 'Número de Telefone',
  'pages.register.phone.required': 'Por favor insira seu número de telefone!',
  'pages.register.phone.invalid': 'Formato de número de telefone inválido!',
  'pages.register.captcha.placeholder': 'Código de Verificação',
  'pages.register.captcha.required':
    'Por favor insira o código de verificação!',
  'pages.register.getVerificationCode': 'Obter Código',
  'pages.register.agreeTerms.label': 'Li e concordo com',
  'pages.register.agreeTerms.serviceTerms': 'Termos de Serviço',
  'pages.register.agreeTerms.and': 'e',
  'pages.register.agreeTerms.privacyPolicy': 'Política de Privacidade',
