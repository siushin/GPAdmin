export default {
  'pages.layouts.userLayout.title':
    'انبار پوکمون شما دیگر هرگز به یک توده پوک بال تبدیل نخواهد شد!',
  'pages.login.accountLogin.tab': 'ورود به حساب کاربری',
  'pages.login.accountLogin.errorMessage': 'نام کاربری / رمزعبور نادرست (مدیر)',
  'pages.login.failure':
    'ورود به سیستم با شکست مواجه شد، لطفا دوباره سعی کنید!',
  'pages.login.success': 'ورود موفق!',
  'pages.login.username.placeholder': 'نام کاربری: مدیر',
  'pages.login.username.required': 'لطفا نام کاربری خود را وارد کنید!',
  'pages.login.password.placeholder': 'رمز عبور: admin',
  ...
  'pages.register.subtitle': 'ایجاد حساب کاربری جدید',
  'pages.register.submit': 'ثبت نام',
  'pages.register.failure': 'ثبت نام با شکست مواجه شد، لطفا دوباره سعی کنید!',
  'pages.register.username.placeholder': 'نام کاربری',
  'pages.register.username.required': 'لطفا نام کاربری خود را وارد کنید!',
  'pages.register.password.placeholder': 'رمز عبور (حداقل 6 کاراکتر)',
  'pages.register.password.required': 'لطفا رمز عبور خود را وارد کنید!',
  'pages.register.password.min': 'رمز عبور باید حداقل 6 کاراکتر باشد!',
  'pages.register.confirmPassword.placeholder': 'تأیید رمز عبور',
  'pages.register.confirmPassword.required': 'لطفا رمز عبور خود را تأیید کنید!',
  'pages.register.confirmPassword.notMatch': 'دو رمز عبور مطابقت ندارند',
  'pages.register.phone.placeholder': 'شماره تلفن',
  'pages.register.phone.required': 'لطفا شماره تلفن خود را وارد کنید!',
  'pages.register.phone.invalid': 'فرمت شماره تلفن نامعتبر است!',
  'pages.register.captcha.placeholder': 'کد تأیید',
  'pages.register.captcha.required': 'لطفا کد تأیید را وارد کنید!',
  'pages.register.getVerificationCode': 'دریافت کد',
  'pages.register.agreeTerms.label': 'خوانده و موافقم با',
  'pages.register.agreeTerms.serviceTerms': 'شرایط استفاده',
  'pages.register.agreeTerms.and': 'و',
  'pages.register.agreeTerms.privacyPolicy': 'سیاست حفظ حریم خصوصی',
