export default {
  'pages.layouts.userLayout.title':
    'আপনার পোকেমন গুদাম আর কখনই পোক বলের স্তূপে পরিণত হবে না!',
  'pages.login.accountLogin.tab': 'অ্যাকাউন্টে লগইন',
  'pages.login.accountLogin.errorMessage': 'ভুল ব্যবহারকারীর নাম/পাসওয়ার্ড(admin)',
  ...
  'pages.register.subtitle': 'নতুন অ্যাকাউন্ট তৈরি করুন',
  'pages.register.submit': 'নিবন্ধন',
  'pages.register.failure': 'নিবন্ধন ব্যর্থ হয়েছে, আবার চেষ্টা করুন!',
  'pages.register.username.placeholder': 'ব্যবহারকারীর নাম',
  'pages.register.username.required': 'আপনার ব্যবহারকারীর নাম লিখুন!',
  'pages.register.password.placeholder': 'পাসওয়ার্ড (সর্বনিম্ন 6 অক্ষর)',
  'pages.register.password.required': 'আপনার পাসওয়ার্ড লিখুন!',
  'pages.register.password.min': 'পাসওয়ার্ড অবশ্যই কমপক্ষে 6 অক্ষর হতে হবে!',
  'pages.register.confirmPassword.placeholder': 'পাসওয়ার্ড নিশ্চিত করুন',
  'pages.register.confirmPassword.required': 'আপনার পাসওয়ার্ড নিশ্চিত করুন!',
  'pages.register.confirmPassword.notMatch': 'দুটি পাসওয়ার্ড মেলে না',
  'pages.register.phone.placeholder': 'ফোন নম্বর',
  'pages.register.phone.required': 'আপনার ফোন নম্বর লিখুন!',
  'pages.register.phone.invalid': 'ফোন নম্বরের ফর্ম্যাট সঠিক নয়!',
  'pages.register.captcha.placeholder': 'যাচাইকরণ কোড',
  'pages.register.captcha.required': 'যাচাইকরণ কোড লিখুন!',
  'pages.register.getVerificationCode': 'কোড পান',
  'pages.register.agreeTerms.label': 'আমি পড়েছি এবং সম্মত',
  'pages.register.agreeTerms.serviceTerms': 'সেবার শর্তাবলী',
  'pages.register.agreeTerms.and': 'এবং',
  'pages.register.agreeTerms.privacyPolicy': 'গোপনীয়তা নীতি',
  'pages.register.agreeTerms.required':
    'অনুগ্রহ করে সেবার শর্তাবলী এবং গোপনীয়তা নীতিতে সম্মত হন',
  'pages.register.haveAccount': 'ইতিমধ্যে একটি অ্যাকাউন্ট আছে?',
  'pages.register.goToLogin': 'প্রবেশ করুন',
  'pages.resetPassword.subtitle': 'পাসওয়ার্ড রিসেট করুন',
  'pages.resetPassword.submit': 'পাসওয়ার্ড রিসেট করুন',
  'pages.resetPassword.failure': 'পাসওয়ার্ড রিসেট ব্যর্থ, অনুগ্রহ করে আবার চেষ্টা করুন!',
  'pages.resetPassword.phone.placeholder': 'ফোন নম্বর',
  'pages.resetPassword.phone.required': 'অনুগ্রহ করে আপনার ফোন নম্বর লিখুন!',
  'pages.resetPassword.phone.invalid': 'ফোন নম্বরের ফরম্যাট বৈধ নয়!',
  'pages.resetPassword.captcha.placeholder': 'যাচাইকরণ কোড',
  'pages.resetPassword.captcha.required': 'অনুগ্রহ করে যাচাইকরণ কোড লিখুন!',
  'pages.resetPassword.getVerificationCode': 'কোড পান',
  'pages.resetPassword.password.placeholder': 'নতুন পাসওয়ার্ড লিখুন (অন্তত 6 অক্ষর)',
  'pages.resetPassword.password.required': 'অনুগ্রহ করে নতুন পাসওয়ার্ড লিখুন!',
  'pages.resetPassword.password.min': 'পাসওয়ার্ড অন্তত 6 অক্ষরের হতে হবে!',
  'pages.resetPassword.confirmPassword.placeholder': 'নতুন পাসওয়ার্ড নিশ্চিত করুন',
  'pages.resetPassword.confirmPassword.required':
    'অনুগ্রহ করে নতুন পাসওয়ার্ড নিশ্চিত করুন!',
  'pages.resetPassword.confirmPassword.notMatch': 'দুটি পাসওয়ার্ড মেলে না',
  'pages.resetPassword.rememberPassword': 'পাসওয়ার্ড মনে পড়েছে?',
  'pages.resetPassword.backToLogin': 'লগইনে ফিরে যান',
